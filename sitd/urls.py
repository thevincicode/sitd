...
urlpatterns = patterns('',
    ...
    url(r'^expediente/imprimir/(?P<id_expediente>\d+)$','sitdapp.views.expediente_imprimir'),
    ...
    url(r'^reportes/$','sitdapp.views.reportes'),
    url(r'^reporte/$','sitdapp.views.reportes_fechas'),
    #aca esta de sergio
    ...
    url(r'^trabajador/editar/(?P<id_trabajador>\d+)$','sitdapp.views.trabajador_editar'),
